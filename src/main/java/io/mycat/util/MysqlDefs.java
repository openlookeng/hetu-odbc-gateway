...
public final class MysqlDefs {
    ...
    public static int javaTypeMysqlStr(String javaType) {

        {
            if (javaType.equalsIgnoreCase("NUMERIC"))
                return MysqlDefs.FIELD_TYPE_DECIMAL;

            if (javaType.equalsIgnoreCase("DECIMAL"))
                return MysqlDefs.FIELD_TYPE_NEW_DECIMAL;

            if (javaType.equalsIgnoreCase("TINYINT"))
                return MysqlDefs.FIELD_TYPE_TINY;

            if (javaType.equalsIgnoreCase("SMALLINT"))
                return MysqlDefs.FIELD_TYPE_SHORT;

            if (javaType.equalsIgnoreCase("INTEGER"))
                return MysqlDefs.FIELD_TYPE_LONG;

            if (javaType.equalsIgnoreCase("REAL"))
                return MysqlDefs.FIELD_TYPE_FLOAT;

            if (javaType.equalsIgnoreCase("DOUBLE"))
                return MysqlDefs.FIELD_TYPE_DOUBLE;

            if (javaType.equalsIgnoreCase("NULL"))
                return MysqlDefs.FIELD_TYPE_NULL;

            if (javaType.equalsIgnoreCase("TIMESTAMP"))
                return MysqlDefs.FIELD_TYPE_TIMESTAMP;

            if (javaType.equalsIgnoreCase("BIGINT"))
                return MysqlDefs.FIELD_TYPE_LONGLONG;

            if (javaType.equalsIgnoreCase("DATE"))
                return MysqlDefs.FIELD_TYPE_DATE;

            if (javaType.equalsIgnoreCase("TIME"))
                return MysqlDefs.FIELD_TYPE_TIME;

            if (javaType.equalsIgnoreCase("VARBINARY"))
                return MysqlDefs.FIELD_TYPE_TINY_BLOB;

            if (javaType.equalsIgnoreCase("LONGVARBINARY"))
                return MysqlDefs.FIELD_TYPE_BLOB;

            if (javaType.equalsIgnoreCase("VARCHAR"))
                return MysqlDefs.FIELD_TYPE_VAR_STRING;

            if (javaType.equalsIgnoreCase("CHAR"))
                return MysqlDefs.FIELD_TYPE_STRING;

            if (javaType.equalsIgnoreCase("BINARY"))
                return MysqlDefs.FIELD_TYPE_GEOMETRY;

            if (javaType.equalsIgnoreCase("BOOLEAN"))
                return MysqlDefs.FIELD_TYPE_BIT;

            if (javaType.equalsIgnoreCase("BIT"))
                return MysqlDefs.FIELD_TYPE_BIT;
            if (javaType.equalsIgnoreCase("CLOB"))
                return MysqlDefs.FIELD_TYPE_VAR_STRING;
            if (javaType.equalsIgnoreCase("BLOB"))
                return MysqlDefs.FIELD_TYPE_BLOB;

            // 修改by magicdoom@gmail.com
            // 当jdbc连接非mysql的数据库时，需要把对应类型映射为mysql的类型，否则应用端会出错
            if (javaType.equalsIgnoreCase("NVARCHAR"))
                return MysqlDefs.FIELD_TYPE_VAR_STRING;
            if (javaType.equalsIgnoreCase("NCHAR"))
                return MysqlDefs.FIELD_TYPE_STRING;
            if (javaType.equalsIgnoreCase("NCLOB"))
                return MysqlDefs.FIELD_TYPE_VAR_STRING;
            if (javaType.equalsIgnoreCase("LONGNVARCHAR"))
                return MysqlDefs.FIELD_TYPE_VAR_STRING;

            // 匹配返回的unknown类型
            if (javaType.equalsIgnoreCase("UNKNOWN"))
