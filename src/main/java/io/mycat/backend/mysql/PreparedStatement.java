...
public class PreparedStatement {
    ...
    private List<FieldPacket> outFieldPks = new LinkedList<>();
    ...
    public void setColumnsNumber(int num) {
        columnsNumber = num;
    }
    ...
    public void setOutFieldPks(List pks) {
        outFieldPks = pks;
    }

    public List<FieldPacket> getOutFieldPks() {
        return outFieldPks;
    }
}