...
public class XMLConfigLoader implements ConfigLoader {
    ...
    /** unmodifiable */
    private final Map<String, DataHostConfig> dataHosts = null;

    /** unmodifiable */
    private final Map<String, DataNodeConfig> dataNodes = null;

    /** unmodifiable */
    private final Map<String, SchemaConfig> schemas = null;
