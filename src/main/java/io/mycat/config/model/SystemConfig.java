...
public final class SystemConfig {
	...
	/**
	 * the default jdbc url prefix is set to be hetu jdb url prefix
	 */
	private static final String JDBC_URL_DEFAULT_PREFIX = "jdbc:hetu://";
	...
	public SystemConfig() {
        ...
        this.txIsolation = Isolations.READ_UNCOMMITTED;
		...
		this.jdbcUrlPrefix = JDBC_URL_DEFAULT_PREFIX;
