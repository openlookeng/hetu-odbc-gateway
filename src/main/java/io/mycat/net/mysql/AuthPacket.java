...
public class AuthPacket extends MySQLPacket {
    ...
    public HashMap<String, String> connectAttrs = new HashMap<>();
    ...
    public void read(byte[] data) {
        ...
        if (((clientFlags & Capabilities.CLIENT_CONNECT_ATTRS) != 0) && mm.hasRemaining()) {
            attrsLength = (int) mm.readLength();
            for (int i = 0; i < attrsLength && mm.hasRemaining(); i++) {
                connectAttrs.put(mm.readStringWithLength(), mm.readStringWithLength());
            }
        }
    }
