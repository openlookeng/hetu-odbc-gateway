...
public abstract class FrontendConnection extends AbstractConnection {
    ...
    public BackendConnection backConn;
    ...
    protected ColumnFieldsHandler columnFieldsHandler;
    ...
    public void setColumnFieldsHandler(ColumnFieldsHandler columnFieldsHandler) {
        this.columnFieldsHandler = columnFieldsHandler;
    }
...
//			return true;
    ...
    public void initDB(byte[] data) {
        ...
        this.catalog = db;
        this.backConn.setCatalog(db);
        this.schema = new String();
        this.backConn.setSchema(new String());
	...
	public void query(String sql) {
		...
		if (queryHandler != null) {
            queryHandler.setReadOnly(false);
	...
	public void stmtPrepare(byte[] data) {
		if (prepareHandler != null) {
			...
			sql = QueryParserUtil.parseAndRewriteQuery(sql);
    ...
    // add fieldList command
    public void fieldList(byte[] data) {
        if (columnFieldsHandler != null) {
            columnFieldsHandler.handle(data);
        } else {
            writeErrMessage(ErrorCode.ER_UNKNOWN_COM_ERROR, "Field_List unsupported!");
        }
    }
